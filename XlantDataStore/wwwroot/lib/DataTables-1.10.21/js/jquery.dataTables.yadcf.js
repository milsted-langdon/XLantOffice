...
(function (factory) {
	...
	var yadcf = function () {
				...
				if (selected_values_trimmed.length !== 0) {
					...
					if (filter_match_mode !== "regex") {
						...
						if (filter_match_mode === "contains") {
							...
							//oTable.DataTable().column(column_number_filter).search(stringForSearch);
						} else if (filter_match_mode === "exact") {
		...
		function addRangeNumberFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char) {
			...
			$(filter_selector_string).append("<input onkeydown=\"yadcf.preventDefaultForEnter(event);\" placeholder=\"" + filter_default_label[1] + "\" id=\"" + toId + "\" class=\"yadcf-filter-range-number yadcf-filter-range form-control\" " + filterActionStr + "></input>");
		...
		function addRangeDateFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
			...
			columnObj = getOptions(oTable.selector)[column_number];
			if (columnObj.datepicker_type === 'bootstrap-datepicker') {
				//removed to avoid width override
